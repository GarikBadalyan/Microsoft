...
let text = "es,sirum,em,hayastan@" 
text = text.split(","); // estex partadir storaket piti dnenq vor ashxati aysinqn inch nshan vor verevn e
console.log(text)
console.log(text[0],text[3])

let text2 = "asdasdfasdff"
console.log(text2.split(""))
function pol(str){
  return str.split("")
}
console.log(pol("Garik"))
